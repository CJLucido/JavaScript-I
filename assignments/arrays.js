...
console.log(lastCar.car_make + " and " + lastCar.car_model);
...
for (i = 0; i < inventory.length; i++){
    carModels.push(inventory[i].car_model); //originally forgot to specify which index I wanted pushed up to carModels
}
//console.log(carModels); //this was just a test to make sure it worked
let carModelsSorted = [];
...
let uniqueYears = carYears.filter(function(year, index){ //personal stretch
